...
var OCPPError = function (_Error) {
  ...
  function OCPPError(code, message, details) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (OCPPError.__proto__ || (0, _getPrototypeOf2.default)(OCPPError)).call(this, code + ': ' + message));

    _this.code = code;
    _this.message = message;
    _this.details = details;

    Error.captureStackTrace(_this, OCPPError);
    return _this;
  }
